...
('朝日新聞 科学', 'https://rss.asahi.com/rss/asahi/science.rdf', 'lifestyle', true),

-- environmentカテゴリ（環境関連）- 代替ソース
('朝日新聞 科学', 'https://rss.asahi.com/rss/asahi/science.rdf', 'environment', true),

-- politicsカテゴリ（政治関連）- 代替ソース
('朝日新聞 科学', 'https://rss.asahi.com/rss/asahi/science.rdf', 'politics', true),

-- economicsカテゴリ（経済関連）- 代替ソース
('東洋経済オンライン', 'https://toyokeizai.net/list/feed/rss', 'economics', true),

-- societyカテゴリ（社会関連）- 代替ソース
('朝日新聞 科学', 'https://rss.asahi.com/rss/asahi/science.rdf', 'society', true); 